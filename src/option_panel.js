...
import * as params from '../src/shared';

params.STATE = {
    camera: {
        targetFPS: 30,  // Ejemplo de configuración inicial
        sizeOption: '640x480',  // Ejemplo de configuración inicial
        cameraSelector: 'default',  // Ejemplo de configuración inicial
    },
    // Otros campos de STATE según sea necesario
};
